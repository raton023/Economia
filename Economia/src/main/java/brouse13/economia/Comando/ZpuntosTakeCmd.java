...
public class ZpuntosTakeCmd implements CommandExecutor {
    Main main;
    public ZpuntosTakeCmd(Main main) {this.main=main;}
    ...
    public boolean onCommand(@NotNull CommandSender s, @NotNull Command c, @NotNull String l, @NotNull String[] a) {
        if(!(s instanceof Player)){
            ...
            if(Bukkit.getPlayer(a[0]) !=null){
                ...
                if(monedas > Integer.parseInt(a[1])){
        ...
        if(!p.hasPermission("dbc.economia.take")){p.hasPermission("§cNo tienes permiso para ejecutar el comando");return false;}
        ...
        if(Bukkit.getPlayer(a[0]) !=null){
            ...
            int monedas = main.mysql.getMonedas(uuid);
                ...
                if(monedas > Integer.parseInt(a[1])){
                    main.mysql.setMonedas(uuid, (monedas-Integer.parseInt(a[1])));
                    p.sendMessage("§aSe han restado§6 "+ a[1]+" §azpuntos a §6"+ p.getName() + "" +
